...
export class XuBreadCrumbComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    renderer.addClass(elementRef.nativeElement, 'xu-breadcrumb');
  }
  ...
  private prepareComponentForRtl(): void {
    if (this.dir === 'rtl') {
      this.renderer.addClass(this.elementRef.nativeElement, 'xu-breadcrumb-rtl');
    } else {
      this.renderer.removeClass(this.elementRef.nativeElement, 'xu-breadcrumb-rtl');
    }
  }
}
